...
namespace Com.Alipay
{
    ...
    public class Submit
    {
        ...
        private static string BuildRequestMysign(String sKey, Dictionary<string, string> sPara)
        {
...
//                    mysign = AlipayMD5.Sign(prestr, _key, _input_charset);
                    mysign = AlipayMD5.Sign(prestr, sKey, _input_charset);
                    break;
                default:
                    mysign = "";
                    break;
        ...
        private static Dictionary<string, string> BuildRequestPara(String sKey, SortedDictionary<string, string> sParaTemp)
        {
            //待签名请求参数数组
            ...
            //获得签名结果
            mysign = BuildRequestMysign(sKey, sPara);
        ...
        private static string BuildRequestParaToString(String sKey, SortedDictionary<string, string> sParaTemp, Encoding code)
        {
            //待签名请求参数数组
            Dictionary<string, string> sPara = new Dictionary<string, string>();
            sPara = BuildRequestPara(sKey, sParaTemp);
        ...
        public static string BuildRequest(string sReqeustUri, string sKey, SortedDictionary<string, string> sParaTemp)
        {
            Encoding code = Encoding.GetEncoding(_input_charset);

            //待请求参数数组字符串
            string strRequestData = BuildRequestParaToString(sKey, sParaTemp, code);
...
//			string strUrl = GATEWAY_NEW + "_input_charset=" + _input_charset;
			string strUrl = sReqeustUri + "?_input_charset=" + _input_charset;
            ...
            {
                strResult = "request error："+exp.Message;
                throw;
            }
